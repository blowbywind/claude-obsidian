...
|----------|-----------|----------|------|
| autobots | AI 에이전트 운영 대시보드 (Fastify+Next.js, SQLite, port 9200) | v2.1 — backend UP (healthy) | 봇 9/9 active (갱신: 12:31Z) | [→](projects/autobots.md) |
...
> 마지막 갱신: 2026-06-21 12:31 UTC (autobots-scheduler)

| 범위 | 파일 수 | 변동 |
|------|------|-----|
| vault 전체 | 752 md | +2 since 12:17Z |
...
| 90-agent-logs/ | 265 md | +2 since 12:17Z |
| session-log.md | 22480라인 | +237 since 12:17Z |
