...
> 마지막 갱신: 2026-06-20T19:31Z (autobots-scheduler) -- session-log 10497라인, vault 557 md

| 범위 | 파일 수 | 변동 |
|------|------|-----|
| vault 전체 | 557 md / 602 all | +11 md |
| wiki/ | 195 md (sources:32, concepts:126[_drafts:42], entities:37) | +7 |
| wiki/concepts/_drafts | 42 | +6 |
