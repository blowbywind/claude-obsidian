...
|----------|-----------|----------|------|
| autobots | AI 에이전트 운영 대시보드 (Fastify+Next.js, SQLite, port 9200) | v2.1 — backend/hermes/ui 전부 UP (healthy) / 봇 8/8 active | [→](projects/autobots.md) |
...
> 마지막 갱신: 2026-06-20 05:01 UTC (autobots-scheduler)

| 범위 | 파일 수 | 변동 |
|------|------|-----|
| vault 전체 | 422 md / 513 전체 | +13 md |
| wiki/ | 136 (root:1, sources:32, concepts:67[drafts:22], entities:33, queries:1) | +2 |
...
| 90-agent-logs/ (bbw-wiki 루트) | 65 md (daily:60, tasks:2, failures:1, weekly:2) | = |
| session-log.md | 1198라인 | ↑196 |
...
| lessons.md | 169 | ~18.1K | 2026-06-20 |
...
| **합계** | **926** | **~50.6K** | +24라인 (lessons.md 교훈 3건 추가) |
