...
|----------|-----------|----------|------|
| autobots | AI 에이전트 운영 대시보드 (Fastify+Next.js, SQLite, port 9200) | v2.1 — backend UP (healthy) | 봇 9/9 active (갱신: 11:32Z) | [→](projects/autobots.md) |
...
> 마지막 갱신: 2026-06-21 11:32 UTC (autobots-scheduler)

| 범위 | 파일 수 | 변동 |
|------|------|-----|
| vault 전체 | 743 md | +3 |
| wiki/ | 251 (sources:32, concepts:180[drafts:54], entities:37) | +1 |
| wiki/concepts/_drafts | 54 | ⚠ 검토 대기 |
| claude/ | 37 md | +1 |
| 50-prompts/ | 6 md (claude:3, codex:2, hermes:1, gemini:0) | = |
| 90-agent-logs/ | 256 md | +2 |
| session-log.md | 21600라인 | +29 since 11:31Z |
