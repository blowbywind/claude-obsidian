...
상태: backend UP (Docker 172.18.0.8:9200, healthy) | hermes-dashboard UP (container, 6d) | ai-ops-ui UP (container, 6d) | 봇 8/8 active
갱신: 2026-06-20 12:33 UTC (scheduler wiki-sync)
...
## 프로젝트 워크스페이스 활동 (DB 기준, 2026-06-20 12:33 UTC)
| 프로젝트 | 최근 활동 | Obsidian 연동 |
|---------|-----------|--------------|
| autobots | 2026-06-20 12:33 UTC | synced |
| hnedu-erp | 2026-06-20 12:31 UTC | synced |
...
## 봇 로스터 (DB 기준, 2026-06-20 12:22 UTC)
| ID | 이름 | 상태 | 모델 | 최근 갱신 |
|----|------|------|------|---------|
