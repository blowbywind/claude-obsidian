...
갱신: 2026-06-21T22:01Z (autobots-scheduler 위키-동기화)

## runtime_providers 상태 (2026-06-21T21:52Z 검증)
| ID | 상태 |
|----|------|
| agy | healthy |
| claude | healthy |
...
## 프로젝트 워크스페이스 활동 (DB 기준, 2026-06-21 22:01 UTC)
| 프로젝트 | 최근 활동 | Obsidian 연동 |
|---------|-----------|--------------|
| autobots | 2026-06-21 08:18 UTC | synced |
| hnedu-erp | 2026-06-21 21:59 UTC | synced |
...
## 위키 동기화 최근 결과 (2026-06-21T22:01Z)
- Bot 상태: 9/9 active (직전 기준, docker API 미접근) | Runtime: agy/claude/codex/obsidian-mcp=healthy | run-gemini=unavailable
- Vault: 900 md (+4 since 896) | session-log: 28454라인 (+147 since 28307) | 90-agent-logs (root): 345 md (+2 since 343) | claude/: 38 md (=)
- ai-ops git: 94aeb81 (변동 없음) | docker: 7 containers running

## 프로파일 동기화 최근 결과 (2026-06-21T21:52Z)
- Bot 상태: 9/9 active
...
- agent-status.json 기준: 2026-06-21T21:41Z